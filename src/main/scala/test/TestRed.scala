...
trait TestRed {
  ...
  def test(): Unit = {
    test(verbose, "test/red0.pcf", "a simple constant function", Option(0)) //ok
    test(verbose, "test/red1.pcf", "calling a simple constant function", Option(11)) //ok
    test(verbose, "test/red2.pcf", "calling a simple function", Option(22)) //ok
    test(verbose, "test/red3.pcf", "calling a simple named function", Option(33)) //ok
